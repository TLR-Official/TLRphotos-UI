...
export async function getPhotos(): Promise<{ success: boolean; data?: PhotoListItem[]; message?: string }> {
...
export async function getPhotoById(id: string): Promise<{ success: boolean; data?: PhotoDetail; message?: string }> {
...
export async function likePhoto(id: string): Promise<{ success: boolean; data?: { likes: number }; message?: string }> {
...
export async function unlikePhoto(id: string): Promise<{ success: boolean; data?: { likes: number }; message?: string }> {
  const response = await request<{ likes: number }>(`/photos/${id}/like`, {
    method: 'DELETE',
  });
  if (response.success && response.data) {
...
export async function incrementView(id: string): Promise<{ success: boolean; data?: { views: number }; message?: string }> {
